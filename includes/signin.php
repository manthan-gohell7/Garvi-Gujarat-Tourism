...
if (isset($_POST['signin'])) {
	...
	if ($query->rowCount() > 0) {
		...
		echo "<script type='text/javascript'> document.location = '" .  $_SESSION['callbackPage'] . "'; </script>";
	} else {
					...
					<div class="login">
						...
						<div class="login-right">
							<form method="post">
								...
								<h4><a href="#" data-dismiss="modal" data-toggle="modal" data-target="#forgetPass">Forgot password</a></h4>
